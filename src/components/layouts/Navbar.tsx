  ...
  return (
    <div className=" w-full flex justify-center h-24 items-center ">
      <div className=" lg:max-w-[1460px] relative px-6 lg:px-8 w-full flex items-center justify-between lg:justify-start flex-1 h-[54px]">
        <div
          onClick={() => navigate("/")}
          className=" w-fit lg:absolute left-6 flex items-center  "
        >
          <img
            alt="logo"
            src="/images/logo.png"
            className=" w-[40px]  lg:w-[54px] object-cover "
          />
        </div>
        ...
        <div className=" absolute right-6 flex items-center z-30 ">
          <p
            ...
            className=" lg:block hidden text-[#00071A] text-lg font-bold ml-20 "
          >
            Launch project
          </p>
              ...
              leftIcon={
                ...
                >
                  <g id="Group">
                    <path
                      id="Vector"
                      d="M1.66669 14.5002C1.66669 13.5277 2.053 12.5951 2.74063 11.9074C3.42826 11.2198 4.36089 10.8335 5.33335 10.8335H12.6667C13.6391 10.8335 14.5718 11.2198 15.2594 11.9074C15.947 12.5951 16.3334 13.5277 16.3334 14.5002C16.3334 14.9864 16.1402 15.4527 15.7964 15.7965C15.4526 16.1403 14.9863 16.3335 14.5 16.3335H3.50002C3.01379 16.3335 2.54747 16.1403 2.20366 15.7965C1.85984 15.4527 1.66669 14.9864 1.66669 14.5002Z"
                      stroke="#EEE5FF"
                      strokeWidth="1.5"
                    ...
                    <path
                      id="Vector_2"
                      d="M9 7.16675C10.5188 7.16675 11.75 5.93553 11.75 4.41675C11.75 2.89796 10.5188 1.66675 9 1.66675C7.48122 1.66675 6.25 2.89796 6.25 4.41675C6.25 5.93553 7.48122 7.16675 9 7.16675Z"
                      stroke="#EEE5FF"
                      strokeWidth="1.5"
                    />
                  </g>
            ...
            <div className=" pt-28 ">
              {!web3Context.isConnected && (
                <ConnectWallet>
                  ...
                  >
                    <p className="text-right text-slate-900 text-sm font-bold ">
                      Connect wallet
                    </p>
                    <svg
                      width="33"
              ...
              >
                ...
                >
                  <rect width="33" height="33" rx="16.5" fill="#5404FF" />
                  <path
                    d="M12.959 17.9166L14.5832 16.2924C14.716 16.1596 14.8962 16.085 15.084 16.085C15.2718 16.085 15.4519 16.1596 15.5848 16.2924L16.7082 17.4158C16.841 17.5486 17.0212 17.6232 17.209 17.6232C17.3968 17.6232 17.5769 17.5486 17.7098 17.4158L20.0423 15.0833M20.0423 15.0833V16.8541M20.0423 15.0833H18.2715"
                    stroke="#E5EDFF"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                    strokeLinejoin="round"
