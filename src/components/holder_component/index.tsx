...
function HolderComponent() {
    ...
    return (
        <div className=" lg:max-w-7xl w-full flex flex-col px-4 lg:px-8 gap-6 " >
            <div className=' bg-white w-[280px] h-[280px] lg:w-[455px] mx-auto lg:h-[455px] rounded-full py-6 lg:py-12 gap-2 flex flex-col items-center ' >
            ...
            <div className=' w-full flex justify-center ml-4 ' >
                <div className="w-fit h-auto flex-col pr-4 border-r border-zinc-500 justify-start items-end inline-flex">
                    ...
                    <div className="text-right text-zinc-500 text-sm font-normal">Rep holders</div>
                </div>
                <div className="w-fit h-auto pl-4 flex-col justify-start items-start inline-flex">
                    ...
                    <div className="text-zinc-500 text-sm font-normal">Reps in circulation</div>
                </div>
            </div>
