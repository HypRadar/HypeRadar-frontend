        ...
        <div className=" lg:max-w-7xl w-full flex flex-col px-4 lg:px-8 gap-6 " >
            <div className=' bg-white w-full rounded-[10px] items-center lg:py-9 lg:px-9 px-0 py-6 gap-12 flex lg:flex-row flex-col ' >
                ...
                <div className=' flex flex-col lg:gap-0 gap-4 lg:w-auto w-full lg:items-start items-center px-6 lg:px-0 ' >
                    <p className="text-slate-900 text-[48px] font-bold  leading-[56px]">Polygon</p>
                    ...
                    <div className="w-full justify-start lg:mt-6 lg:items-start items-center gap-4 flex-col flex lg:flex-row">
                        ...
                        <div className="p-4 lg:w-fit bg-green-200 rounded-[5px] lg:flow-row flex-col justify-center items-end gap-1 inline-flex">
                            <p className="text-right text-green-700 text-xs lg:text-[24px] font-bold ">Rep price: $4,343</p>
                        </div>
            ...
            <div className=' bg-white w-full rounded-[10px] items-center  lg:py-9 lg:px-9 px-6 py-6 gap-6 flex lg:flex-row flex-col-reverse ' >
                <div className=' w-full flex flex-col gap-2 lg:mt-0 mt-8 ' >
                    {Header(false)}
                    <div className="w-full text-zinc-800 text-lg font-normal ">
