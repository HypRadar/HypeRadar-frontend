import { Input, Tooltip, Button, useDisclosure } from '@chakra-ui/react'
    ...
    return (
        <div className=' w-full px-6 ' >
            <div className=" flex items-center gap-3 " >
                <div className=" w-fit " >
                    <div className="w-[80px] h-[80px] lg:w-[120px] lg:h-[120px] relative">
                        ...
                        <img alt='buy' className=" w-[60px] h-[60px] lg:w-[100px] lg:h-[100px] left-[10px] top-[10px] absolute rounded-full shadow" src="https://via.placeholder.com/100x100" />
                    </div>
                </div>
            ...
            <div className=' w-full gap-3 flex flex-col py-4 ' >
                ...
                <div className="w-full flex items-center px-2  py-4 bg-[#E5FFE8] rounded-[5px] justify-start">
                    <div className=' gap-1 ' > <span className="text-neutral-600 text-xs  font-bold">Bitcoin Project</span> <span className="text-neutral-600 text-xs font-normal gap-1"> will receive 10% of your purchase as Project royalty</span>
                    </div>
                    <div className=' w-fit ' >
                        <Tooltip isOpen={isOpen} label="Project royalty is set by the Project. You can set yours too if you have a Project" aria-label='A tooltip'>
                            {/* <CustomCard> */}
                            <svg 
          onMouseEnter={onOpen}
          onMouseLeave={onClose}
          onClick={onToggle} width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
