        ...
        <div className=' w-full px-6 ' >
            ...
            <div className=' w-full gap-3 flex flex-col py-4 ' >
                ...
                <div className="w-full pl-2  py-4 bg-[#E5FFE8] rounded-[5px] justify-start items-start inline-flex">
                    <div className=' gap-1 ' > <span className="text-neutral-600 text-xs  font-bold">Bitcoin Project</span> <span className="text-neutral-600 text-xs font-normal gap-1"> will receive 10% of your purchase as Project royalty <Tooltip label="Project royalty is set by the Project. You can set yours too if you have a Project" aria-label='A tooltip'>
                                {/* <CustomCard> */}
