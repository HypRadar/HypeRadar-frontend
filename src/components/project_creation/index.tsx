import { Input, Select, Textarea, Button, Text, useToast } from '@chakra-ui/react'
...
function ProjectCreation() {
    ...
    const formik = useFormik({
        initialValues: { name: '', ticker: '', category: '', website: '', twitter: '', discord: '', telegram: '', youtube: '', bio: '' },
                        ...
                        <div className=' w-full flex flex-col gap-6 ' >
                            <div className=' w-full flex flex-col gap-2  ' >
                                ...
                                <InputComponent
                                    ...
                                    cursor={window?.location?.pathname?.includes("edit") ? "not-allowed" : "auto"}
                            ...
                            {window?.location?.pathname?.includes("edit") && (
                                <div className=' w-full flex flex-col gap-2  ' >
                                    ...
                                    <Input onChange={(e) => setRoyality(e.target.value)} placeholder='10%' fontSize={["sm", "medium"]} height={["38px", "54px"]} bgColor={"#EBEDF2"} />
                                </div>
                            )}
                            <div className=' w-full flex flex-col gap-2  ' >
                                ...
                                <InputComponent
                                    ...
                                    disabled={window?.location?.pathname?.includes("edit") ? true : false} cursor={window?.location?.pathname?.includes("edit") ? "not-allowed" : "auto"}
                                />
                            ...
                            <div className=' w-full flex flex-col gap-2  ' >
                                ...
                                <Select
                                    ...
                                    placeholder='Choose category' fontSize={["sm", "medium"]} height={["38px", "54px"]} bgColor={"#EBEDF2"} >
                                ...
                                {formik.touched.category && formik.errors.category && (
                                    <Text as={motion.p}
                                        ...
                                        animate={{ y: 0, opacity: 1 }} color="#E84545" fontWeight="600" fontSize="xs" mt="-8px" textAlign="left" >{formik.errors.category}</Text>
                                )}
                            </div>
                            <div className=' w-full flex flex-col gap-2  ' >
                                ...
                                <InputComponent
                                    ...
                                    onChange={formik.handleChange}
                                    onFocus={() =>
                                        formik.setFieldTouched("website", true, true)
                                    }
                            ...
                            <div className=' w-full flex flex-col gap-2  ' >
                                ...
                                <InputComponent
                                    ...
                                    onChange={formik.handleChange}
                                    onFocus={() =>
                                        formik.setFieldTouched("twitter", true, true)
                                    }
                            ...
                            <div className=' w-full flex flex-col gap-2  ' >
                                ...
                                <InputComponent
                                    ...
                                    onChange={formik.handleChange}
                                    onFocus={() =>
                                        formik.setFieldTouched("discord", true, true)
                                    }
                            ...
                            <div className=' w-full flex flex-col gap-2  ' >
                                ...
                                <InputComponent
                                    ...
                                    onChange={formik.handleChange}
                                    onFocus={() =>
                                        formik.setFieldTouched("telegram", true, true)
                                    }
                            ...
                            <div className=' w-full flex flex-col gap-2  ' >
                                ...
                                <InputComponent
                                    ...
                                    onChange={formik.handleChange}
                                    onFocus={() =>
                                        formik.setFieldTouched("youtube", true, true)
                                    }
                    ...
                    <div className=' bg-white w-full rounded-[10px] lg:px-9 py-9 px-4 gap-5 flex lg:flex-row flex-col-reverse ' >
                        <div className=' w-full flex flex-col gap-2 ' >
                            ...
                            <Textarea
                                ...
                                height={["250px", "500px"]} borderColor={"#EBEDF2"} /> 
            ...
            {tab &&
                ...
                <div className=" lg:max-w-7xl w-full flex flex-col px-4 lg:px-8 gap-4 " >
                    <div className=' bg-white w-full rounded-[10px] py-9 lg:px-9 px-4 gap-5 flex flex-col ' >
                        ...
                        <div className=' w-full flex flex-col gap-2  ' >
                            <p className=' text-[#4D4D4D] ' ><span className=' text-[#D20000] ' >*</span> Project royality</p>
                            <Input onChange={(e) => setRoyality(e.target.value)} placeholder='10%' height={"54px"} bgColor={"#EBEDF2"} />
                        </div>
                    </div>
                    <Button onClick={() => submit()} mt={"4"} rounded={"30px"} bgColor={"#5404FF"} color={"white"} _hover={{ backgroundColor: "#5404FF" }} py={"4"} >
                        Create Project
                    </Button>
