    ...
    return (
        <div className=' w-full flex justify-center h-24 items-center ' >
            <div className=" lg:max-w-[1460px] px-6 lg:px-8 w-full flex items-center justify-between lg:justify-start flex-1 h-[54px]">
                ...
                <div className=' lg:ml-auto lg:px-0 px-5 flex items-center ' >
                    <InputGroup>
                ...
                {profile && (
                    <Button onClick={() => navigate("/project")} display={["none", "none", "flex"]} bgColor={"#5404FF"} ml={"6"} _hover={{ backgroundColor: "#5404FF" }} height={"54px"} leftIcon={
                        ...
                        <div className=' pt-28 ' >
                            {!profile && (
                                <div role='button' onClick={() => setProfile((prev) => !prev)} className=' flex items-center w-full py-3 justify-end gap-4 ' >
                                    <p className="text-right text-slate-900 text-sm font-bold font-['Inter']">Connect wallet</p>
                                    <svg width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect width="33" height="33" rx="16.5" fill="#5404FF" />
                            ...
                            {profile && (
                                <div role='button' onClick={() => clickHandler("/project")} className=' flex items-center w-full py-3 justify-end gap-4 ' >
                                    <p className="text-right text-slate-900 text-sm font-bold font-['Inter']">Profile</p>
                            ...
                            <div role='button' onClick={() => clickHandler("/gainer")} className=' flex items-center w-full py-3 justify-end gap-4 ' >
                                <p className="text-right text-slate-900 text-sm font-bold font-['Inter']">Top daily gainers</p>
                                <svg width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect width="33" height="33" rx="16.5" fill="#5404FF" />
                            ...
                            <div role='button' onClick={() => clickHandler("/create")} className=' flex items-center w-full py-3 justify-end gap-4 ' >
                                <p className="text-right text-slate-900 text-sm font-bold font-['Inter']">Create project</p>
                                <svg width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect width="33" height="33" rx="16.5" fill="#5404FF" />
